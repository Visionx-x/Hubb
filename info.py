...
BOT_TOKEN = environ.get('BOT_TOKEN', '7048477254:AAFsobc6VXFphbI9wijKSoLfusYhKh0dsCU')
#---------------------------------------------------------------
#---------------------------------------------------------------
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002291646953'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/LB_Movies')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002480884401').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://DanishDBINN:DanishDBINN@cluster0.eqwbl.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/LB_Movies') #Support group link ( make sure bot is admin )
#---------------------------------------------------------------
#---------------------------------------------------------------
